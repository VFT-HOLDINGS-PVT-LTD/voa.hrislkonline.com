...
class Report_Attendance_OT extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('Reports/Attendance/Report_Attendance_In_Out_OT', $data);
    }
...
//        var_dump($data);die;
        ...
        $this->load->view('Reports/Attendance/rpt_In_Out_OT', $data);
    }
