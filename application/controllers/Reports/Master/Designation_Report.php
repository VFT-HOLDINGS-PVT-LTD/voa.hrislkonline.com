...
class Designation_Report extends CI_Controller {
    ...
    public function Report_designation() {
        ...
        $Data['data_set'] = $this->Db_model->getfilteredData("SELECT 
                                                                    count(EmpNo) as EmpCount, tbl_designations.Des_ID, tbl_designations.Desig_Name
                                                                FROM
                                                                    tbl_empmaster
                                                                        left JOIN
                                                                    tbl_designations ON tbl_empmaster.Des_ID = tbl_designations.Des_ID
                                                                    GROUP BY tbl_designations.Des_ID");

        $this->load->view('Reports/Master/rpt_Designation', $Data);
    }
