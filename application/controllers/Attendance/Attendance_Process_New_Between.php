            ...
            for ($x = 0; $x < count($dtEmp['EmpData']); $x++) {
                ...
                if ($FromDate <= $ToDate) {
                    ...
                    if (!empty($ShiftDetails['shift'][0]->ID_Roster)) {
                        ...
                        if ($shift_type == "DU" || $shift_type == "EX") {
                            $InDate = '';
                            $InTime = '';
                            $OutDate = '';
                            $OutTime = '';
                            ...
                            tbl_u_attendancedata where AttDateTimeStr BETWEEN '$modified_fromtimepre' AND '$modified_fromtimeold' AND Enroll_No='$EmpNo' and AttDate='" . $FromDate . "' AND Status='0' ");
                            ...
                            tbl_u_attendancedata where AttDateTimeStr BETWEEN '$modified_totimepre' AND '$modified_totimeold' AND Enroll_No='$EmpNo' and AttDate='" . $FromDate . "' AND Status='1' ");
                            ...
                            if ($OutTime == null) {
                                ...
                                tbl_u_attendancedata where Enroll_No='$EmpNo' and AttDate='" . $newDate . "' AND Status='1' AND AttDateTimeStr <'$modified_totimeold' ");
                                $OutDate = $dt_out_Records['dt_out_Records'][0]->AttDate;
                                $OutTime = $dt_out_Records['dt_out_Records'][0]->OutTime;
                            }
                        ...
                        // echo $ID_Roster.' '.$from_date.' '.$to_date.' '.$from_time.' '.$to_time.' '.$shift_day.' /'.$InTime.' '.$OutTime.' '.$ED;
                        // echo "<br>";
                    ...
                    if (!empty($ShiftDetails['shift'][1]->ID_Roster)) {
                        ...
                        if ($shift_type1 == "DU" || $shift_type == "EX") {
                            $InDate1 = '';
                            $InTime1 = '';
                            $OutDate1 = '';
                            $OutTime1 = '';
                            ...
                            tbl_u_attendancedata where AttDateTimeStr BETWEEN '$modified_fromtimepre1' AND '$modified_fromtimeold1' AND Enroll_No='$EmpNo' and AttDate='" . $FromDate . "' AND Status='0' ");
                            ...
                            tbl_u_attendancedata where AttDateTimeStr BETWEEN '$modified_totimepre1' AND '$modified_totimeold1' AND Enroll_No='$EmpNo' and AttDate='" . $FromDate . "' AND Status='1' ");
                            ...
                            if ($OutTime1 == null) {
                                ...
                                // Get the CheckOut in the nextDay (before 9am)
                                $dt_out_Records['dt_out_Records1'] = $this->Db_model->getfilteredData("select min(AttTime) as OutTime,Enroll_No,AttDate from 
                                tbl_u_attendancedata where Enroll_No='$EmpNo' and AttDate='" . $newDate . "' AND Status='1' AND AttDateTimeStr <'$modified_totimeold1' ");
                                $OutDate1 = $dt_out_Records['dt_out_Records1'][0]->AttDate;
                                $OutTime1 = $dt_out_Records['dt_out_Records1'][0]->OutTime;
                            }
                    ...
                    if (!empty($ShiftDetails['shift'][2]->ID_Roster)) {
                        ...
                        if ($shift_type2 == "DU" || $shift_type == "EX") {
                            $InDate2 = '';
                            $InTime2 = '';
                            $OutDate2 = '';
                            $OutTime2 = '';
                    ...
                    if (!empty($ShiftDetails['shift'][3]->ID_Roster)) {
                        ...
                        if ($shift_type3 == "DU" || $shift_type == "EX") {
                            $InDate3 = '';
                            $InTime3 = '';
                            $OutDate3 = '';
                            $OutTime3 = '';
