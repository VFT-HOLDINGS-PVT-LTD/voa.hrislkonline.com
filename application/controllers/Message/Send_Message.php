...
class Send_Message extends CI_Controller {
    ...
    public function index() {
        ...
        $data['title'] = "Send Message | HRM System";
        ...
        $data['data_set'] = $this->Db_model->getfilteredData("SELECT 
                                                                ...
                                                                FROM
                                                                    tbl_messages
                                                                        INNER JOIN
                                                                    tbl_empmaster ON tbl_empmaster.EmpNo = tbl_messages.recever
                                                                    
                                                                    ");
        $this->load->view('Message/Send_Message/index', $data);
    }
...
//            echo $q;die;
        ...
        $this->Db_model->get_auto_cus_name($q);
