...
class Weekly_Roster extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['data_set'] = $this->Db_model->getfilteredData("select RosterCode,RosterName,MonthType,CurrentYear,Data from tbl_rosterpatternweeklyhd WHERE RosterCode > 'RS0594' AND Data = 'Individual Employee' OR RosterCode > 'RS0594' AND Data = 'OnlyGroup';");
