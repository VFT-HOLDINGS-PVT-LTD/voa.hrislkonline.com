                    ...
                    <ul class="acc-menu">
                        ...
                        <?php if ($currentUser[0]->Leave_Transaction == 1): ?>
                            ...
                            <ul class="acc-menu">
                                ...
                                <?php if ($currentUser[0]->leave_entry == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/Cover_Up_Leave_Entry">COVER-UP LEAVE ENTRY</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Payroll_reports == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Payroll_reports == 1): ?>    
                                ...
                                <?php endif; ?>
                                 ...
                                 <?php if ($currentUser[0]->payslip_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Bank_Sheet/Report_Bank_Sheet">BANK SHEET</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Tools == 1): ?>
                            <li class="nav-separator">Terms and Conditions</li>
                        <?php endif; ?>

                        <?php if ($currentUser[0]->System_backup == 1): ?>
                            <li><a href="<?php echo base_url(); ?>Terms_and_Conditions/Terms_and_Conditions/"><i class="fa fa-inbox"></i><span>TERMS AND CONDITIONS</span></a></li>
                        <?php endif; ?>
