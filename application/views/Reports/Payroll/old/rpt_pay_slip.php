...
$html = '
           ...
           <hr>
             ...
             <br>
                ...
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ED Amount</td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Early_departure, 2, '.', ',') . '</td>
                </tr>
                ...
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ATT Allowances</td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Att_Allowance, 2, '.', ',') . '</td>
                </tr>
                <tr>
