            ...
            <table cellpadding="4">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black; font-weight:bold"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; width:90px;">NAME</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:85px;">DEPARTMENT</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:60px;">BASIC</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:70px;">INCENTIVE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:70px;">GROSS SAL</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:60px;">BUDG ALW</th>
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;width:50px;">NOPAY DAYS</th>
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;width:50px;">DEDUCTIONS</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:50px;">LOAN</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:50px;">ADVANCE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:50px;">EPF</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;width:50px;">ALLOWANCES</th>
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;width:90px;">' . $data->Emp_Full_Name . '</td> 
                        <td style="font-size:10px;width:85px;">' . $data->Dep_Name . '</td>    
                        <td style="font-size:10px;width:60px;">' . $data->Basic_sal . '</td>
                            <td style="font-size:10px;width:70px;">' . $data->Incentive . '</td>
                                <td style="font-size:10px;width:70px;">' . ($data->Basic_sal+$data->Incentive) . '</td>
                            <td style="font-size:10px;width:60px;">' . $data->Basic_sal . '</td>
                        
                        <td style="font-size:10px;width:50px;">' . number_format(  $data->Normal_OT_Pay, 2, '.', ',') . '</td>
                        <td style="font-size:10px;width:50px;">' . number_format(  $data->Normal_OT_Pay, 2, '.', ',') . '</td>
                        <td style="font-size:10px;width:50px;">' . $data->No_Pay_days . '</td>
                        ...
                        <td style="font-size:10px;width:50px;">' . $data->Deductions . '</td>
                        <td style="font-size:10px;width:50px;">' . $data->Loan_Instalment . '</td>
                        <td style="font-size:10px;width:50px;">' . $data->Salary_advance . '</td>
                        <td style="font-size:10px;width:50px;">' . $data->EPF_Worker_Amount . '</td>
                        <td style="font-size:10px;width:50px;">' . $data->Allowances . '</td>
