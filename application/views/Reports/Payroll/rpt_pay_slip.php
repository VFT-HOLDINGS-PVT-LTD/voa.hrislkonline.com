...
$html = '
            ...
            <h6 style="margin-left:200px; text-align:center; ">' . $PDF_HEADER_TITLE . '</h6>
            ...
            <table  width="" style="font-size:9px;margin-left: 500px;">
                <tr>
                    ...
                    <td width="180" height="10">' . $data_set[0]->Emp_Full_Name . '</td>
                </tr>
                <tr>
                    <td width="120" height="10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Emp ID</td>
                    
                    <td width="180" height="10">' . $data_set[0]->EmpNo . '</td>
                </tr>
           ...
           <hr>
             ...
             <table width="" border="0" align="left" style="font-size:8px;font-family:calibri">
             <br>
                <tr>
                ...
                <tr>
                    ...
                    <td ></td>
                    <td align="right">' . number_format($data_set[0]->Br_pay, 2, '.', ',') . '</td>
                </tr>

               
                
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Performance Allowance </td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Performance, 2, '.', ',') . '</td>
                </tr>
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Attenadance Allowance </td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Attendances, 2, '.', ',') . '</td>
                </tr>
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vehicle Allowance</td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Traveling, 2, '.', ',') . '</td>
                </tr>
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fuel Allowance</td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Fuel, 2, '.', ',') . '</td>
                </tr>
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Phone Allowance</td>
                    <td > </td>
                ...
                <tr style="font-weight:bold">
                    ...
                    <td > </td>
                    <td  align="right">' . number_format($data_set[0]->Gross_pay, 2, '.', ',') . '</td>
                </tr>
                <br>
                ...
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mobile Deduction</td>
                    <td > </td>
                    <td align="right">' . number_format(0, 2, '.', ',') . '</td>
                </tr>
                
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Payee Tax</td>
                    <td > </td>
                    <td align="right">' . number_format($data_set[0]->Payee_amount, 2, '.', ',') . '</td>
                </tr>
                <tr>
