...
$html = '
        <div style="margin-left:200px; text-align:center; font-size:13px;">MOBILE IN OUT REPORT ROW</div>
            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;  width:100px;">DATE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;  width:100px;">TIME</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;  width:160px;">LOCATION</th>
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        <td  style="font-size:10px;   width:60px;">' . $data->Enroll_No . '</td>
                        <td style="font-size:10px;  width:100px;">' . $data->AttDate . '</td> 
                        <td style="font-size:10px;  width:100px;">' . $data->AttTime . '</td>
                        <td style="font-size:10px;  width:120px;">' . $data->AttPlace . '</td>
                    </tr>'
