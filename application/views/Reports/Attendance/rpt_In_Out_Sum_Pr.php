...
$html = '
        <div style="margin-left:200px; text-align:center; font-size:13px;">PRESENT REPORT</div>
            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        <th style="font-size:11px;border-bottom: 1px solid black; width:100px;">EMP NO</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:200px;">NAME</th>
...
foreach ($data_set2 as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td  style="font-size:10px; width:200px;">' . $data->Emp_Full_Name . '</td>
                        <td style="font-size:10px; width:100px;">' . $data->AttDate . '</td> 
                        <td style="font-size:10px;">' . $data->First_In . '</td>    
                        <td style="font-size:10px;">' . $data->Last_Out . '</td>
               </tr>'
