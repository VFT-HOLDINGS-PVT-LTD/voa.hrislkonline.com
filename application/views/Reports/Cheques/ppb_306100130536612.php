...
<h4 style='letter-spacing: 12px; font-size: 17px; margin-left: -186px; margin-top:218px;'>$c_date_D$c_date_M$c_date_Y "." </h4>
<br>
<h6 style='margin-left: -450px; margin-top:-45px; text-decoration: underline overline; line-height:-10px;'>$cross</h6>
<div>
<h4 style='margin-left: 276px; margin-top:320px; position: absolute; transform: rotate(270deg);  line-height:10px;  '>$payee</h4>
    </div>

<div>
<h5 style='width: 320px; margin-left:307px; line-height:20px; transform: rotate(270deg); position: absolute;   margin-top:310px;'>$amount_w Only</h5>
</div>
<div>
...
<div style='    '>
<div >
<h4 style='margin-left: 377px; margin-top:-70px; transform: rotate(270deg);  position: absolute;'></h4>
</div>  
<div>
<h5 style='margin-left: 435px; margin-top:-70px; transform: rotate(270deg);  position: absolute;'></h5>
</div>
<div>
<h6 style='margin-left: 450px; margin-top:-85px; transform: rotate(270deg);  position: absolute;'></h6>
</div>
</div>
