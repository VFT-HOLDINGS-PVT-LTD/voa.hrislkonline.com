...
<div style='    '>
<div >
<h5 style='margin-left: 377px; margin-top:-70px; transform: rotate(270deg);  position: absolute;'></h5>
</div>  
<div>
<h5 style='margin-left: 435px; margin-top:-70px; transform: rotate(270deg);  position: absolute;'></h5>
</div>
<div>
<h6 style='margin-left: 450px; margin-top:-70px; transform: rotate(270deg);  position: absolute;'></h6>
</div>
</div>
...
$dompdf->render();
$dompdf->stream("ntb_13100010460.pdf", array("Attachment" => false));
exit(0);
?>
