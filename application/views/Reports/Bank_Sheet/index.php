                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="">BANK SHEET REPORT</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-primary">
                                                        <div class="panel-heading">
                                                            <h2>BANK SHEET REPORT</h2>
                                                        </div>

                                                        <div class="panel-body">
                                                            <div style="font-size: 15px; font-weight: bold;"
                                                                class="bg-bright">REPORT BY BANK SHEET</div>
                                                             <form
                                                                action="<?php echo base_url(); ?>Reports/Bank_Sheet/Report_Bank_Sheet/Bank_Sheet_Report_By_Cat_Excel"
                                                                class="form-horizontal" id="frm_in_out_rpt"
                                                                name="frm_in_out_rpt" method="POST"> 
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-6">
                                                                        <img class="imagecss"
                                                                            src="<?php echo base_url(); ?>assets/images/bankT.jpg">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" id="cmb_branch"
                                                                            ...
                                                                            <?php foreach ($data_branch as $t_data) { ?>
                                                                                <option value="<?= $t_data->B_id; ?>">
                                                                                    <?= $t_data->B_name; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-3">
                                                                    <label for="cmb_departments"
                                                                        class="col-sm-4 control-label">Departments</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control"
                                                                            id="cmb_departments" name="cmb_departments">
                                                                            <option value="" default>-- Select --
                                                                            </option>
                                                                            <?php foreach ($data_dep as $t_data) { ?>
                                                                                <option value="<?= $t_data->Dep_ID; ?>">
                                                                                    <?= $t_data->Dep_Name; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-3">
                                                                    <label for="cmb_ass_departments"
                                                                        class="col-sm-4 control-label">Assigned
                                                                        Department</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control"
                                                                            id="cmb_ass_departments"
                                                                            name="cmb_ass_departments">
                                                                            <option value="" default>-- Select --
                                                                            </option>
                                                                            <?php foreach ($data_ass_c as $t_data) { ?>
                                                                                <option value="<?= $t_data->ass_dep_id; ?>">
                                                                                    <?= $t_data->ass_dep_name; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                     <input type="submit" id="search" name="search"
                                                                        formtarget="_blank"
                                                                        class="btn-green btn fa fa-check" value="&nbsp;&nbsp;VIEW&nbsp;REPORT&nbsp;EXCEL"> 
                                                                    <button type="button" id="search1" name="search1"
                                                                        class="btn-green btn fa fa-check">&nbsp;&nbsp;VIEW&nbsp;
                                                                        REPORT</button>
                                                                    <button type="button" id="cancel" name="cancel"
                                                                        class="btn-danger-alt btn fa fa-check">&nbsp;&nbsp;CLEAR</button>
                                                                </div>
                                                             </form> 
    ...
    <script>
        $(document).ready(function () {
            $("#search1").click(function (e) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>Reports/Bank_Sheet/Report_Bank_Sheet/Bank_Sheet_Report_By_Cat",
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    success: function (response) {
                        ...
                        newWindow.document.addEventListener('DOMContentLoaded', function () {
                            ...
                            XLSX.utils.book_append_sheet(wb, ws, 'Bank Sheet'); // Updated sheet name
                            XLSX.writeFile(wb, 'Bank_Sheet.xlsx'); // Updated file name
                        });
                    },
