                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="index.html">COVER-UP LEAVE ENTRY</a></li>
                            ...
                            <div class="page-tabs">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active"><a data-toggle="tab" href="#tab1">COVER-UP LEAVE ENTRY</a></li>
                                    <li><a data-toggle="tab" href="#tab2">VIEW COVER-UP LEAVE</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            <div class="panel-heading"><h2>COVER-UP LEAVE ENTRY</h2></div>
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_leave_entry" name="frm_leave_entry" action="<?php echo base_url(); ?>Leave_Transaction/Cover_Up_Leave_Entry/insert_Data" method="POST">
                                                                    ...
                                                                    <div class="form-group col-sm-12">
                                                                        <div class="col-sm-8">
                                                                            <img class="imagecss" src="<?php echo base_url(); ?>assets/images/add_leave.png" >
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" required="" id="cmb_leave_type" name="cmb_leave_type" >
                                                                                    ...
                                                                                    <option value="" default>-- Select --</option>
                                                                                    <option value="Cover_Up_Leave_Entry" >Cover Up Leave Entry</option>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label date">Leave Date</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" required="required" id="dpd2" name="Leave_date">
                                                                            </div>

                                                                        </div>

                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label date">Cover-Up Date</label>
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control" required="required" id="dpd1" name="Cover_Up_date">
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" required="" id="cmb_day" name="cmb_day" disabled>
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body panel-no-padding">
                                                            <table id="example"
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    foreach ($cup_leave as $data) {


                                                                        echo "<tr class='odd gradeX'>";
                                                                        echo "<td width='100'>" . $data->CP_ID . "</td>";
                                                                        echo "<td width='100'>" . $data->EmpNo . "</td>";
                                                                        echo "<td width='100'>" . $data->Cover_Up_Date . "</td>";
                                                                        echo "<td width='100'>" . $data->Leave_Date . "</td>";
                                                                        echo "<td width='100'>" . $data->Leave_Day . "</td>";
                                                                        echo "<td width='100'>" . $data->Leave_Reason . "</td>";
                                                                        echo "</tr>";
                                                                    }
                                                                    ?>
                                                                </tbody>
