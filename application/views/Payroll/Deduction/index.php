                ...
                <form class="form-horizontal" id="frm_in_out_rpt" name="frm_in_out_rpt" method="POST">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-sm-3">
                                <label for="focusedinput" class="col-sm-4 control-label">Deduction Type</label>
                                <div class="col-sm-8">
                                    <select class="form-control" required="" id="cmb_fixedDeduction3" name="cmb_fixedDeduction3">
                        ...
                        <div class="form-group col-sm-6">
                                <label for="focusedinput" class="col-sm-4 control-label">Deduction Status <span style="color: red;">*</span></label>
                                <div class="col-sm-4">
                                    <select class="form-control" id="cmb_Deductionstatus3" name="cmb_Deductionstatus3" required="required">


                                        <option value="" default>-- Select --</option>
                                        <option value="varialble_deduction">Varialble Deduction</option>
