                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            <div class="panel-heading"><h2>ADD ALLOWANCES</h2></div>
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_allowance_types" name="frm_allowance_types" action="<?php echo base_url(); ?>Master/Allowance_Types/insert_data" method="POST">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Allowance Type Name</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" id="txt_allowance" name="txt_allowance" placeholder="Ex: Fual Allowance">
                                                                        </div>
                                                                ...
                                                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($data_set as $data) {
                                                                            ...
                                                                            echo "<td width='15'>";
                                                                            echo "<button class='get_data btn btn-green'  data-toggle='modal' data-target='#myModal' title='EDIT' data-id='$data->Alw_ID' href='" . base_url() . "index.php/Master/Department/get_details" . $data->Alw_ID . "'><i class='fa fa-edit'></i></button>";
                                                                            echo "</td>";

                                                                            echo "<td width='15'>";


                                                                            // echo "<button  class=' btn btn-danger' data-toggle='modal' href='javascript:void()' title='DELETE' ><i class='fa fa-times-circle'></i></a>";
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" action="<?php echo base_url(); ?>Master/Allowance_Types/edit" method="post">
                                                        <div class="form-group col-sm-12">
                                                            <label for="focusedinput" class="col-sm-4 control-label">ID</label>
                                                            <div class="col-sm-8">
                                                                <input value="<?php echo $data->Alw_ID; ?>" type="text" class="form-control" readonly="readonly" name="id" id="id" class="m-wrap span3" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input value="" type="text" name="Allowance_Name" id="Allowance_Name"  class="form-control m-wrap span6"><br>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <label class="checkbox green col-sm-5">
                                                                ...
                                                                <input type="checkbox" name="is_Fixced" id="is_Fixced">
                                                            </label>
                                                        </div>
                                                    </div>
