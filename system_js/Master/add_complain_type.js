...
//             $('#txt_B_name').val($(this).val());
    ...
    $("#frmComplainType").submit(function (e) {
        ...
        var jqXHR = $.ajax({
            type: "POST",
            url: baseurl + "index.php/Add_Complain_type/insert_complain_type",
            data: $("#frmComplainType").serialize(),
            ...
            success: function (data) {
                ...
                if (data1[0].a > 0)
                {
                    $("#spnmessage").html(' <b>  New Complain Type added successfully.</b>');
