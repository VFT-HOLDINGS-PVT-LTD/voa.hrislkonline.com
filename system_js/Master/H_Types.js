...
//    var jqXHR = $.ajax({
//        type: "POST",
//        url: baseurl + "Master/Holiday_Types/insert_H_Types",
//        data: $("#frm_H_Types").serialize(),
...
//            if (data1[0].a > 0)
//            {
//                $("#spnmessage").html(' <b>  New Holiday Types added successfully.</b>');
...
$(".get_data").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: baseurl + "index.php/Master/Holiday_Types/get_details",
        data: {'id': ID},
        dataType: "JSON",
...
//                    alert(response);
            for (var i = 0; i < response.length; i++) {
                ...
                $('#H_Desc').val(response[i].HTDescription);
